...
<div id="testingInstructions">
    ...
    <strong>Important testing notes</strong> (PLEASE READ if you are here for the first time). <a href="#" id="notesCollapseLink">[Read Notes]</a>
        ...
        <ul>
            ...
            <li>Please report any issues or problems you run into [here](https://github.com/acl2017/acl2017.github.io/issues). Click on the "New Issue" button at the top right.
        </ul>
    </div>
</div>
